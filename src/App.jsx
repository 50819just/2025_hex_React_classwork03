...
function App() {
  ...
  const handelOpenProductModal = (mode, product) => {
    ...
    const modalIinstance = Modal.getInstance
                    ...
                    <tr key={product.id}>
                      ...
                      <td>
                        <div className="btn-group">
                          <button onClick={() => handelOpenProductModal('edit', product)} type="button" className="btn btn-outline-primary btn-sm">編輯</button>
                          <button onClick={()=> handelOpenDelProductModal(product)} type="button" className="btn btn-outline-danger btn-sm">刪除</button>
                        </div>
                      </td>
                    </tr>
                  ))}
        ...
        <div className="modal-dialog modal-dialog-centered modal-xl">
          <div className="modal-content border-0 shadow">
            <div className="modal-header border-bottom">
              ...
              <button onClick={handelCloseProductModal} type="button" className="btn-close" aria-label="Close"></button>
            </div>
            ...
            <div className="modal-footer border-top bg-light">
              <button onClick={handelCloseProductModal} type="button" className="btn btn-secondary">
                取消
              </button>
              <button onClick={handleUpdataProduct} type="button" className="btn btn-primary">
                確認
              </button>
            </div>
          </div>
